...
public class Test {
	...
	File directory = new File ("mydir");//Directory(klasör) oluþturur.
	directory.mkdir();
	...
	File []fileArray = directory.listFiles();//listFiles File objesi döner ve bunlarý
											//bir File Array de tutarak dosyalarýmýzýn 
											//ne oldugunu yazdýrabiliriz
	
	for (File file : fileArray) {//dosyalarýmýzý yazdýrýyoruz
		i++;
