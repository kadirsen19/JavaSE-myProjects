...
public class Islemler {
	...
	public void dosyaKlasorIslemleri() {
		...
		{
				System.out.println(dosyaKlasor.getName()+" isimli bir dosya bulunmaktadýr.");
			
			if(dosyaKlasor.isFile())
			{
				System.out.println("Belirtilen konumdaki nesne bir dosyadýr."+" Dosya ismi :"+dosyaKlasor.getName());
			}
			else {
				System.out.println("Belirtilen adresteki nesne dosya deðildir");
			}
		...
		{
		System.out.println("Belirtilen adreste--> "+konum+" isimli nesne bulunamadý !");
		}
	}
}
